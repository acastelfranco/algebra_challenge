...
\item\contentsline{section}{\mbox{\hyperlink{class_endpoint}{Endpoint}} \\*Represents an endpoint in the raceway. The endpoint has a 3D position and a flag to indicate whether or not it needs to be reinforced }{\pageref{class_endpoint}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{class_raceway}{Raceway}} \\*Represents a \mbox{\hyperlink{class_raceway}{Raceway}} graph. This stores the \mbox{\hyperlink{class_segment}{Segment}} and \mbox{\hyperlink{class_endpoint}{Endpoint}} objects that make up the graph. The graph can be built by adding endpoints and segments and can be queried }{\pageref{class_raceway}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{class_segment}{Segment}} \\*Represents a segment in the raceway. A segment is created with the endpoints at the start and end of the segment }{\pageref{class_segment}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{struct_test_data}{Test\+Data}} \\*Structure for hard-\/coding test data for support computation. Endpoints and segments can be defined as data and can be assigned names which are useful for testing the results of the support computation. This class can create a \mbox{\hyperlink{class_raceway}{Raceway}} from the hard-\/coded endpoints and segment vectors }{\pageref{struct_test_data}}{}
\item\contentsline{section}{\mbox{\hyperlink{struct_test_endpoint}{Test\+Endpoint}} \\*Structure to help in writing hard-\/coded tests of support computation }{\pageref{struct_test_endpoint}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{struct_test_segment}{Test\+Segment}} \\*Structure to help in writing hard-\/coded tests of support computation }{\pageref{struct_test_segment}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{class_vector}{Vector}} \\*Represents a point or a vector with 3D Cartesian coordinates }{\pageref{class_vector}}{}
